...
/**
 * Lifecycle states of a {@link PerformanceCarePlan}.
 *
 * <pre>
 ...
 * </pre>
 */
public enum PerformanceCareStatus {
    ...
    PerformanceCareStatus(int code, String displayName, String description) {
        this.code        = (byte) code;
    ...
    /** Resolve a {@code PerformanceCareStatus} from its numeric code. */
    public static PerformanceCareStatus fromCode(byte code) {
        for (PerformanceCareStatus s : values()) {
            if (s.code == code) return s;
        }
        throw new IllegalArgumentException("Unknown PerformanceCareStatus code: " + code);
    }
}
