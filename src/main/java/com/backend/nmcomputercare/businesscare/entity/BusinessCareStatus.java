...
/**
 * Lifecycle states of a {@link BusinessCarePlan}.
 *
 * <pre>
 ...
 *  4  WAITING_APPOINTMENT  – Paid; waiting for the technician appointment
 *  5  COMPLETED            – Service fully delivered to all units
 * </pre>
 */
public enum BusinessCareStatus {
    ...
    COMPLETED(5,          "Completed",           "Service has been fully delivered to all units.");

    private final byte   code;
    private final String displayName;
    private final String description;

    BusinessCareStatus(int code, String displayName, String description) {
        this.code        = (byte) code;
    ...
    public static BusinessCareStatus fromCode(byte code) {
        for (BusinessCareStatus s : values()) {
            if (s.code == code) return s;
        }
        throw new IllegalArgumentException("Unknown BusinessCareStatus code: " + code);
    }
}
